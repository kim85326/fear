...
interface ICloseStoryDDialogButtonProps {
  handleClick: () => void;
}

interface ICloseStoryDDialogButtonState {
  color: string;
}

class CloseStoryDDialogButton extends React.Component<
  ICloseStoryDDialogButtonProps,
  ICloseStoryDDialogButtonState
> {
  public constructor(props: ICloseStoryDDialogButtonProps) {
    super(props);
    this.state = {
      color: "#E77452"
    };
...
export default CloseStoryDDialogButton;
