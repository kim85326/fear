...
class ButtonF extends React.Component<IButtonFProps, IButtonFState> {
  ...
  public componentWillReceiveProps(nextProps: IButtonFProps) {
    // 當 props 改變，且顯示按鈕時
