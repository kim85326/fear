...
class ButtonG extends React.Component<IButtonGProps, IButtonGState> {
  ...
  public componentWillReceiveProps(nextProps: IButtonGProps) {
    // 當 props 改變，且顯示按鈕時
