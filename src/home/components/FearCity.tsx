...
class FearCity extends React.Component {
  public render() {
    return (
      <svg
        className="fear-city"
      ...
      >
		...
		s0,17.2,6.9,17.2c7.3,0,6.4-13,6.4-21.3"
            ...
            <line
              ...
              y2="268.6"
            />
            <line className="st59" x1="227" y1="263.3" x2="241.7" y2="263.3" />
            <line
              className="st59"
              x1="227.1"
              y1="258.4"
            ...
            <line
              ...
              y2="303.2"
            />
            <line className="st59" x1="227" y1="297.9" x2="241.7" y2="297.9" />
