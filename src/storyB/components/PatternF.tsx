...
interface IPatternFProps {
  isShowPattern: boolean;
}

class PatternF extends React.Component<IPatternFProps> {
  constructor(props: IPatternFProps) {
    super(props);
  }
  ...
  public render() {
    return (
      <svg
        className={`patternF ${this.props.isShowPattern ? "show" : ""}`}
        version="1.1"
