    ...
    return (
      ...
      >
		...
		c0,0,4.7,1,4.3,9c-0.3,8-42.7,6.7-42.7,6.7s-4.3,4-13.3,4.3c-9,0.3-16.8-3.1-30.7-2.5C30.9,61.6,10.2,61.3,0,57.9z"
            ...
            />
            <circle fill="#84725E" stroke="#84725E" strokeWidth="2.2229" strokeMiterlimit="10" cx="55.1" cy="39" r="4.5" />
            <circle fill="#84725E" stroke="#84725E" strokeWidth="2.2229" strokeMiterlimit="10" className="st79" cx="76.8" cy="39" r="4.5" />
          </g>
        </a>
