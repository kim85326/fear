...
class ButtonI extends React.Component<IButtonIProps, IButtonIState> {
  ...
  public componentWillReceiveProps(nextProps: IButtonIProps) {
    // 當 props 改變，且顯示按鈕時
