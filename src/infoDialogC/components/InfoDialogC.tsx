...
import CloseInfoDialogCButton from "./CloseInfoDialogCButton";
import InfoDialogCPicture from "./InfoDialogCPicture";

interface IInfoDialogCProps {
  isShow: boolean;
  isShowing: boolean;
  isHiding: boolean;
  handleClick: () => void;
...
interface IInfoDialogCState {
  isShowDialogText: boolean;
}

class InfoDialogC extends React.Component<
  IInfoDialogCProps,
  IInfoDialogCState
> {
  constructor(props: IInfoDialogCProps) {
    super(props);
    this.state = {
  ...
  public componentWillReceiveProps(nextProps: IInfoDialogCProps) {
    // props 要求顯示對話框時
